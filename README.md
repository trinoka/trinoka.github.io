...
public/
├── brand-assets/        # Brand assets (logos, favicon, OG banner)
│   ├── trinoka-favicon.svg
│   ├── trinoka-logo-primary.svg
│   ├── trinoka-logo-horizontal.svg
│   ├── trinoka-logo-mark.svg
│   ├── trinoka-social-icon.svg
│   └── trinoka-banner.svg
└── robots.txt           # Generated by `src/pages/robots.txt.ts` (dynamic)
```
